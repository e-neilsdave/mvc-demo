 ...
 */
class Gain extends \Sofid\AdminBundle\Entity\Gain implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'commercant', 'user', 'nbPoints', 'timestamp', 'lastScan', 'shared');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gain $proxy) {
