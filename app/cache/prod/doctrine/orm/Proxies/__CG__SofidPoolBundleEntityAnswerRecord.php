 ...
 */
class AnswerRecord extends \Sofid\PoolBundle\Entity\AnswerRecord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'answer', 'created', 'question', 'option', 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnswerRecord $proxy) {
