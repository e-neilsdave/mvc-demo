 ...
 */
class Categories extends \Sofid\AdminBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'category_name', 'main_category');
        }
    ...
    public function setMainCategory($mainCategory)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMainCategory', array($mainCategory));

        return parent::setMainCategory($mainCategory);
    }
