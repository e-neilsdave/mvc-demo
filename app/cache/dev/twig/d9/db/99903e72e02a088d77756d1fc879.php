...
/* SofidAdminBundle:Form:duplicate_merchant.html.twig */
class __TwigTemplate_d9db99903e72e02a088d77756d1fc879 extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, "object"), "code")) {
            // line 3
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("duplicate_commercant", array("id" => $this->getAttribute($this->getContext($context, "object"), "id"))), "html", null, true);
            echo "\">Duplicate merchant</a>
    ";
        }
        // line 5
        echo "</td>";
    ...
    {
        return "SofidAdminBundle:Form:duplicate_merchant.html.twig";
    }
