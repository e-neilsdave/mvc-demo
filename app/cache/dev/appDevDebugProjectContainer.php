...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'F:/wamp/www/armel_symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('F:/wamp/www/armel_symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'F:/wamp/www/armel_symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'F:/wamp/www/armel_symfony/app/Resources');
    ...
    /**
     * Gets the 'card.encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sofid\AdminBundle\Listener\CardEncoder A Sofid\AdminBundle\Listener\CardEncoder instance.
     */
    protected function getCard_EncoderService()
    {
        return $this->services['card.encoder'] = new \Sofid\AdminBundle\Listener\CardEncoder();
    }

    /**
     * Gets the 'code.encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sofid\UserBundle\Listener\CodeEncoder A Sofid\UserBundle\Listener\CodeEncoder instance.
     */
    protected function getCode_EncoderService()
    {
        return $this->services['code.encoder'] = new \Sofid\UserBundle\Listener\CodeEncoder();
    }

    /**
     * Gets the 'commercant.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sofid\AdminBundle\Listener\CommercantClient A Sofid\AdminBundle\Listener\CommercantClient instance.
     */
    protected function getCommercant_ClientService()
    {
        return $this->services['commercant.client'] = new \Sofid\AdminBundle\Listener\CommercantClient();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventListener(array(0 => 'postPersist'), $this->get('commercant.client'));
        $f->addEventListener(array(0 => 'postPersist'), $this->get('card.encoder'));
        $f->addEventListener(array(0 => 'postPersist'), $this->get('code.encoder'));
        $f->addEventListener(array(0 => 'postGenerateSchema'), 'security.acl.dbal.schema_listener');

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'sofid_1', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => array()), $c, $f, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager53b45c8c85b2d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager53b45c8c85b2d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'F:/wamp/www/armel_symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_53b45c8c85b2d.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_748be4b2e0777ce021e4a5875828dc60');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_748be4b2e0777ce021e4a5875828dc60');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_748be4b2e0777ce021e4a5875828dc60');

        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle\\Resources\\config\\doctrine' => 'Sonata\\UserBundle\\Entity'));
        $e->setGlobalBasename('mapping');

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\AdminBundle\\Entity', 1 => 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\UserBundle\\Entity', 2 => 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\FideleBundle\\Entity', 3 => 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\PoolBundle\\Entity'));

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'FOS\\UserBundle\\Entity');
        $g->addDriver($e, 'Sonata\\UserBundle\\Entity');
        $g->addDriver($f, 'Sofid\\AdminBundle\\Entity');
        $g->addDriver($f, 'Sofid\\UserBundle\\Entity');
        $g->addDriver($f, 'Sofid\\FideleBundle\\Entity');
        $g->addDriver($f, 'Sofid\\PoolBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SofidAdminBundle' => 'Sofid\\AdminBundle\\Entity', 'SofidUserBundle' => 'Sofid\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'SofidFideleBundle' => 'Sofid\\FideleBundle\\Entity', 'PoolBundle' => 'Sofid\\PoolBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('F:/wamp/www/armel_symfony/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager53b45c8c85b2d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Sofid\CommercantBundle\Services\Export A Sofid\CommercantBundle\Services\Export instance.
     */
    protected function getExportService()
    {
        return $this->services['export'] = new \Sofid\CommercantBundle\Services\Export($this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'F:/wamp/www/armel_symfony/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '6a955ac31d3cb68edbeec37ce69f39ec3776668a');
    }
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), 'F:/wamp/www/armel_symfony/app/cache/dev', array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'JMSAopBundle' => 'JMS\\AopBundle\\JMSAopBundle', 'JMSDiExtraBundle' => 'JMS\\DiExtraBundle\\JMSDiExtraBundle', 'JMSSecurityExtraBundle' => 'JMS\\SecurityExtraBundle\\JMSSecurityExtraBundle', 'DoctrineMigrationsBundle' => 'Doctrine\\Bundle\\MigrationsBundle\\DoctrineMigrationsBundle', 'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle', 'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle', 'SonataBlockBundle' => 'Sonata\\BlockBundle\\SonataBlockBundle', 'SonatajQueryBundle' => 'Sonata\\jQueryBundle\\SonatajQueryBundle', 'SonataAdminBundle' => 'Sonata\\AdminBundle\\SonataAdminBundle', 'SonataDoctrineORMAdminBundle' => 'Sonata\\DoctrineORMAdminBundle\\SonataDoctrineORMAdminBundle', 'KnpMenuBundle' => 'Knp\\Bundle\\MenuBundle\\KnpMenuBundle', 'SonataEasyExtendsBundle' => 'Sonata\\EasyExtendsBundle\\SonataEasyExtendsBundle', 'StofDoctrineExtensionsBundle' => 'Stof\\DoctrineExtensionsBundle\\StofDoctrineExtensionsBundle', 'SofidAdminBundle' => 'Sofid\\AdminBundle\\SofidAdminBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'FOSAdvancedEncoderBundle' => 'FOS\\AdvancedEncoderBundle\\FOSAdvancedEncoderBundle', 'SofidCommercantBundle' => 'Sofid\\CommercantBundle\\SofidCommercantBundle', 'SofidUserBundle' => 'Sofid\\UserBundle\\SofidUserBundle', 'SonataUserBundle' => 'Sonata\\UserBundle\\SonataUserBundle', 'SofidFideleBundle' => 'Sofid\\FideleBundle\\SofidFideleBundle', 'PoolBundle' => 'Sofid\\PoolBundle\\PoolBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    {
        return $this->services['fos_user.profile.form'] = $this->get('form.factory')->createNamed('fos_user_profile_form', 'sofid_edit_commercant', NULL, array('validation_groups' => array(0 => 'Profile', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Sofid\\UserBundle\\Entity\\Commercant');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Sofid\\UserBundle\\Entity\\Commercant');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Sofid\\UserBundle\\Entity\\Commercant');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('F:/wamp/www/armel_symfony/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('F:/wamp/www/armel_symfony/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'nexmo_sms_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sofid\UserBundle\Helper\Nexmo A Sofid\UserBundle\Helper\Nexmo instance.
     */
    protected function getNexmoSmsManagerService()
    {
        return $this->services['nexmo_sms_manager'] = new \Sofid\UserBundle\Helper\Nexmo($this);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:F:/wamp/www/armel_symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'F:/wamp/www/armel_symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $f->setCacheDir('F:/wamp/www/armel_symfony/app/cache/dev/jms_security/expressions');
     ...
     * This method always returns the same instance of the service.
     *
     * @return FOS\AdvancedEncoderBundle\Security\Encoder\EncoderFactory A FOS\AdvancedEncoderBundle\Security\Encoder\EncoderFactory instance.
     */
    protected function getSecurity_EncoderFactoryService()
    {
        return $this->services['security.encoder_factory'] = new \FOS\AdvancedEncoderBundle\Security\Encoder\EncoderFactory(new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Sofid\\UserBundle\\Entity\\Commercant' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000)))), array('FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000)), 'sofid_encoder' => $this->get('sofid.sofid_encoder')));
    }
     ...
     * @return Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_CommercantService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/commercant/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/commercant/logout'));
        $f->addHandler($this->get('security.logout.handler.session'));

        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('default_target_path' => '/commercant', 'login_path' => '/login', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $g->setProviderKey('commercant');

        return $this->services['security.firewall.map.context.commercant'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'commercant', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'commercant', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '53b45c8bd4135', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'commercant', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($a, array('always_use_default_target_path' => false, 'default_target_path' => '/commercant', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_COMMERCANT' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_COMMERCANT', 1 => 'ROLE_USER', 2 => 'ROLE_ADMIN', 3 => 'ROLE_SUPER_ADMIN', 4 => 'ROLE_ALLOWED_TO_SWITCH', 5 => 'ROLE_SONATA_ADMIN_COMMERCANT_LIST', 6 => 'ROLE_SONATA_ADMIN_COMMERCANT_EDIT'), 'SONATA' => array(0 => 'ROLE_SONATA_PAGE_ADMIN_PAGE_EDIT')));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('F:/wamp/www/armel_symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('F:/wamp/www/armel_symfony/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('F:/wamp/www/armel_symfony/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('F:/wamp/www/armel_symfony/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'sofid.sofid_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sofid\AdminBundle\Security\Encoder\SofidEncoder A Sofid\AdminBundle\Security\Encoder\SofidEncoder instance.
     */
    protected function getSofid_SofidEncoderService()
    {
        return $this->services['sofid.sofid_encoder'] = new \Sofid\AdminBundle\Security\Encoder\SofidEncoder();
    }

    /**
     * Gets the 'sofid.user.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sofid\UserBundle\Form\Type\ProfileType A Sofid\UserBundle\Form\Type\ProfileType instance.
     */
    protected function getSofid_User_Profile_Form_TypeService()
    {
        return $this->services['sofid.user.profile.form.type'] = new \Sofid\UserBundle\Form\Type\ProfileType('Sofid\\UserBundle\\Entity\\Commercant');
    }
    ...
    /**
     * Gets the 'sonata.admin.card' service.
     *
     * @return Sofid\AdminBundle\Admin\CardAdmin A Sofid\AdminBundle\Admin\CardAdmin instance.
     */
    protected function getSonata_Admin_CardService()
    {
        $instance = new \Sofid\AdminBundle\Admin\CardAdmin('sonata.admin.card', 'Sofid\\AdminBundle\\Entity\\Card', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('SofidAdminBundle');
     ...
     *
     * @return Sofid\AdminBundle\Admin\CategoriesAdmin A Sofid\AdminBundle\Admin\CategoriesAdmin instance.
     */
    protected function getSonata_Admin_CategoriesService()
    {
        $instance = new \Sofid\AdminBundle\Admin\CategoriesAdmin('sonata.admin.categories', 'Sofid\\AdminBundle\\Entity\\Categories', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.city' service.
     *
     * @return Sofid\AdminBundle\Admin\CityAdmin A Sofid\AdminBundle\Admin\CityAdmin instance.
     */
    protected function getSonata_Admin_CityService()
    {
        $instance = new \Sofid\AdminBundle\Admin\CityAdmin('sonata.admin.city', 'Sofid\\AdminBundle\\Entity\\City', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.commercant' service.
     *
     * @return Sofid\AdminBundle\Admin\CommercantAdmin A Sofid\AdminBundle\Admin\CommercantAdmin instance.
     */
    protected function getSonata_Admin_CommercantService()
    {
        $instance = new \Sofid\AdminBundle\Admin\CommercantAdmin('sonata.admin.commercant', 'Sofid\\UserBundle\\Entity\\Commercant', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.gain' service.
     *
     * @return Sofid\AdminBundle\Admin\GainAdmin A Sofid\AdminBundle\Admin\GainAdmin instance.
     */
    protected function getSonata_Admin_GainService()
    {
        $instance = new \Sofid\AdminBundle\Admin\GainAdmin('sonata.admin.gain', 'Sofid\\AdminBundle\\Entity\\Gain', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.offre' service.
     *
     * @return Sofid\AdminBundle\Admin\OffreAdmin A Sofid\AdminBundle\Admin\OffreAdmin instance.
     */
    protected function getSonata_Admin_OffreService()
    {
        $instance = new \Sofid\AdminBundle\Admin\OffreAdmin('sonata.admin.offre', 'Sofid\\AdminBundle\\Entity\\Offre', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.palier' service.
     *
     * @return Sofid\AdminBundle\Admin\PalierAdmin A Sofid\AdminBundle\Admin\PalierAdmin instance.
     */
    protected function getSonata_Admin_PalierService()
    {
        $instance = new \Sofid\AdminBundle\Admin\PalierAdmin('sonata.admin.palier', 'Sofid\\AdminBundle\\Entity\\Palier', 'SonataAdminBundle:CRUD');
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'SoFID', '/bundles/sonataadmin/logo_title.png', array('html5_validate' => true));
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.commercant', 1 => 'sonata.admin.card', 2 => 'sonata.admin.user', 3 => 'sonata.admin.offre', 4 => 'sonata.admin.palier', 5 => 'sonata.admin.gain', 6 => 'sonata.admin.categories', 7 => 'sonata.admin.city'));
        $instance->setAdminGroups(array('Users' => array('label' => 'Users', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.commercant', 1 => 'sonata.admin.user', 2 => 'sonata.admin.palier', 3 => 'sonata.admin.gain')), 'Cards' => array('label' => 'Cards', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.card')), 'Offres' => array('label' => 'Offres', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.offre')), 'Category' => array('label' => 'Category', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.categories')), 'City' => array('label' => 'City', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.city'))));
        $instance->setAdminClasses(array('Sofid\\UserBundle\\Entity\\Commercant' => 'sonata.admin.commercant', 'Sofid\\AdminBundle\\Entity\\Card' => 'sonata.admin.card', 'Sofid\\AdminBundle\\Entity\\User' => 'sonata.admin.user', 'Sofid\\AdminBundle\\Entity\\Offre' => 'sonata.admin.offre', 'Sofid\\AdminBundle\\Entity\\Palier' => 'sonata.admin.palier', 'Sofid\\AdminBundle\\Entity\\Gain' => 'sonata.admin.gain', 'Sofid\\AdminBundle\\Entity\\Categories' => 'sonata.admin.categories', 'Sofid\\AdminBundle\\Entity\\City' => 'sonata.admin.city'));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.commercant', 1 => 'sonata.admin.card', 2 => 'sonata.admin.user', 3 => 'sonata.admin.offre', 4 => 'sonata.admin.palier', 5 => 'sonata.admin.gain', 6 => 'sonata.admin.categories', 7 => 'sonata.admin.city'), $this);
    }
     ...
     *
     * @return Sofid\AdminBundle\Admin\UserAdmin A Sofid\AdminBundle\Admin\UserAdmin instance.
     */
    protected function getSonata_Admin_UserService()
    {
        $instance = new \Sofid\AdminBundle\Admin\UserAdmin('sonata.admin.user', 'Sofid\\AdminBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.block.form.type.block'] = new \Sonata\BlockBundle\Form\Type\ServiceListType($this->get('sonata.block.manager'), array('admin' => array(0 => 'sonata.admin.block.admin_list'), 'cms' => array(0 => 'sonata.block.service.text', 1 => 'sonata.block.service.rss', 2 => 'sonata.block.service.qrcode')));
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array('sonata.admin.block.admin_list' => array(), 'sonata.block.service.text' => array(), 'sonata.block.service.rss' => array(), 'sonata.block.service.qrcode' => array()));
    }
    ...
    {
        return $this->services['sonata.user.profile.form.type'] = new \Sonata\UserBundle\Form\Type\ProfileType('Sofid\\UserBundle\\Entity\\Commercant');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'F:/wamp/www/armel_symfony/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('commercant', '/commercant/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev/translations', 'debug' => true));

        $instance->setFallbackLocale('en');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf', 'af', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf', 'cy', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf', 'no', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf', 'sq', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf', 'tr', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf', 'uk', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf', 'lv', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ua.xlf', 'ua', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ar.xlf', 'ar', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ca.xlf', 'ca', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.cs.xlf', 'cs', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.da.xlf', 'da', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.de.xlf', 'de', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.en.xlf', 'en', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.es.xlf', 'es', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.fa.xlf', 'fa', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.fr.xlf', 'fr', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.gl.xlf', 'gl', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.hu.xlf', 'hu', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.it.xlf', 'it', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.lb.xlf', 'lb', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.nl.xlf', 'nl', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.no.xlf', 'no', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.pl.xlf', 'pl', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.pt_BR.xlf', 'pt_BR', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.pt_PT.xlf', 'pt_PT', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ro.xlf', 'ro', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ru.xlf', 'ru', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sk.xlf', 'sk', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sl.xlf', 'sl', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sr_Cyrl.xlf', 'sr_Cyrl', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sr_Latn.xlf', 'sr_Latn', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sv.xlf', 'sv', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.tr.xlf', 'tr', 'security');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ua.xlf', 'ua', 'security');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.bg.yml', 'bg', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ca.yml', 'ca', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.cs.yml', 'cs', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.da.yml', 'da', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.de.yml', 'de', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.et.yml', 'et', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fa.yml', 'fa', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fi.yml', 'fi', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hr.yml', 'hr', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hu.yml', 'hu', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.it.yml', 'it', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ja.yml', 'ja', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lb.yml', 'lb', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lt.yml', 'lt', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lv.yml', 'lv', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nl.yml', 'nl', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pl.yml', 'pl', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_BR.yml', 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_PT.yml', 'pt_PT', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ro.yml', 'ro', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ru.yml', 'ru', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sk.yml', 'sk', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sl.yml', 'sl', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sr_Latn.yml', 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sv.yml', 'sv', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.tr.yml', 'tr', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.uk.yml', 'uk', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.zh_CN.yml', 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.da.yml', 'da', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fa.yml', 'fa', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fi.yml', 'fi', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hr.yml', 'hr', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hu.yml', 'hu', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ja.yml', 'ja', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lt.yml', 'lt', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lv.yml', 'lv', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt.yml', 'pt', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sk.yml', 'sk', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sl.yml', 'sl', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sr_Latn.yml', 'sr_Latn', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sv.yml', 'sv', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.tr.yml', 'tr', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.zh_CN.yml', 'zh_CN', 'validators');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.bg.xliff', 'bg', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ca.xliff', 'ca', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.cs.xliff', 'cs', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.de.xliff', 'de', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.en.xliff', 'en', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.es.xliff', 'es', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.eu.xliff', 'eu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.fa.xliff', 'fa', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.hr.xliff', 'hr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.hu.xliff', 'hu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.it.xliff', 'it', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ja.xliff', 'ja', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.lb.xliff', 'lb', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.nl.xliff', 'nl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.pl.xliff', 'pl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.pt.xliff', 'pt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.pt_BR.xliff', 'pt_BR', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ro.xliff', 'ro', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ru.xliff', 'ru', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.sk.xliff', 'sk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.sl.xliff', 'sl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.uk.xliff', 'uk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.zh_CN.xliff', 'zh_CN', 'SonataAdminBundle');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\AdminBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\CommercantBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\UserBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.bg.xliff', 'bg', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.ca.xliff', 'ca', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.cs.xliff', 'cs', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.de.xliff', 'de', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.en.xliff', 'en', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.es.xliff', 'es', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.fa.xliff', 'fa', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.fr.xliff', 'fr', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.it.xliff', 'it', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.nl.xliff', 'nl', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.pl.xliff', 'pl', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.pt.xliff', 'pt', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.ru.xliff', 'ru', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.sk.xliff', 'sk', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.sl.xliff', 'sl', 'SonataUserBundle');
        $instance->addResource('xliff', 'F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.zh_TW.xliff', 'zh_TW', 'SonataUserBundle');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\FideleBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'F:\\wamp\\www\\armel_symfony\\src\\Sofid\\PoolBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'F:/wamp/www/armel_symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'F:/wamp/www/armel_symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('F:/wamp/www/armel_symfony/app/Resources/TwigBundle/views', 'Twig');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\block-bundle\\Sonata\\BlockBundle/Resources/views', 'SonataBlock');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/views', 'SonataAdmin');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\doctrine-orm-admin-bundle\\Sonata\\DoctrineORMAdminBundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\src\\Sofid\\AdminBundle/Resources/views', 'SofidAdmin');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\src\\Sofid\\CommercantBundle/Resources/views', 'SofidCommercant');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\src\\Sofid\\UserBundle/Resources/views', 'SofidUser');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/views', 'SonataUser');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\src\\Sofid\\FideleBundle/Resources/views', 'SofidFidele');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\src\\Sofid\\PoolBundle/Resources/views', 'Pool');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('F:/wamp/www/armel_symfony/app/Resources/views');
        $instance->addPath('F:\\wamp\\www\\armel_symfony\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6a955ac31d3cb68edbeec37ce69f39ec3776668a');
    }
     ...
     *
     * @return EntityManager53b45c8c85b2d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'F:/wamp/www/armel_symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('F:/wamp/www/armel_symfony/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/commercant/'), array(0 => 'ROLE_COMMERCANT'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/commercant/.*'), array(0 => 'ROLE_COMMERCANT'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('53b45c8bd4135'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('53b45c8bd4135'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'commercant', $c, true), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('53b45c8bd4135')), true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('F:/wamp/www/armel_symfony/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'F:/wamp/www/armel_symfony/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'F:/wamp/www/armel_symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev',
            'kernel.logs_dir' => 'F:/wamp/www/armel_symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'SofidAdminBundle' => 'Sofid\\AdminBundle\\SofidAdminBundle',
                'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle',
                'FOSAdvancedEncoderBundle' => 'FOS\\AdvancedEncoderBundle\\FOSAdvancedEncoderBundle',
                'SofidCommercantBundle' => 'Sofid\\CommercantBundle\\SofidCommercantBundle',
                'SofidUserBundle' => 'Sofid\\UserBundle\\SofidUserBundle',
                'SonataUserBundle' => 'Sonata\\UserBundle\\SonataUserBundle',
                'SofidFideleBundle' => 'Sofid\\FideleBundle\\SofidFideleBundle',
                'PoolBundle' => 'Sofid\\PoolBundle\\PoolBundle',
            ...
            'locale' => 'en',
            'secret' => '6a955ac31d3cb68edbeec37ce69f39ec3776668a',
            ...
            'debug.container.dump' => 'F:/wamp/www/armel_symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'kernel.secret' => '6a955ac31d3cb68edbeec37ce69f39ec3776668a',
            ...
            'session.save_path' => 'F:/wamp/www/armel_symfony/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'F:\\wamp\\www\\armel_symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'F:\\wamp\\www\\armel_symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:F:/wamp/www/armel_symfony/app/cache/dev/profiler',
            ...
            'router.resource' => 'F:/wamp/www/armel_symfony/app/cache/dev/assetic/routing.yml',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_SUPER_ADMIN' => array(
                    ...
                    5 => 'ROLE_SONATA_ADMIN_COMMERCANT_LIST',
                    6 => 'ROLE_SONATA_ADMIN_COMMERCANT_EDIT',
                ),
                'SONATA' => array(
            ...
            'twig.options' => array(
                ...
                'cache' => 'F:/wamp/www/armel_symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'F:/wamp/www/armel_symfony/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'F:/wamp/www/armel_symfony/app/../web',
            'assetic.write_to' => 'F:/wamp/www/armel_symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'F:/wamp/www/armel_symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_53b45c8c85b2d.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager53b45c8c85b2d_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'F:/wamp/www/armel_symfony/app/cache/dev/jms_security',
            ...
            'doctrine_migrations.dir_name' => 'F:/wamp/www/armel_symfony/app/DoctrineMigrations',
            ...
            'fos_user.model.user.class' => 'Sofid\\UserBundle\\Entity\\Commercant',
            'fos_user.template.engine' => 'twig',
            'fos_user.profile.form.type' => 'sofid_edit_commercant',
